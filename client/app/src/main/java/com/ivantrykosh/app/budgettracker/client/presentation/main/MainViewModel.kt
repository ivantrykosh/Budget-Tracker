...
open class MainViewModel @Inject constructor(
    ...
    init {
        getUser()
        getAccounts()
        getTransactions(_getAccountsState.value.accounts.map { it.accountId }, getStartMonth(), getEndMonth())
    }

    private fun getStartMonth(): String {
    ...
    private fun getEndMonth(): String {
        val calendar = Calendar.getInstance()
