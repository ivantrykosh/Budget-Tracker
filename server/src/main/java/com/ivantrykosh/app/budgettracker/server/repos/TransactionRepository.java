...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
     ...
     */
    List<Transaction> findAllByAccountAccountIdOrderByDateDesc(@NonNull Long accountId);
     ...
     * @return Found transactions
     */
    List<Transaction> findAllByAccountAccountIdInOrderByDateDesc(@NonNull List<Long> accountIds);
     ...
     * @return Found transactions
     */
    List<Transaction> findAllByAccountAccountIdInAndDateBetweenOrderByDateDesc(@NonNull List<Long> accountIds, @NonNull Date startDate, @NonNull Date endDate);
     ...
     */
    List<Transaction> findAllByAccountAccountIdInAndValueGreaterThanOrderByDateDesc(@NonNull List<Long> accountIds, @NonNull Double value, Pageable pageable);
     ...
     * @return A list of transactions matching the criteria
     */
    List<Transaction> findAllByAccountAccountIdInAndValueLessThanOrderByDateDesc(@NonNull List<Long> accountIds, @NonNull Double value, Pageable pageable);
